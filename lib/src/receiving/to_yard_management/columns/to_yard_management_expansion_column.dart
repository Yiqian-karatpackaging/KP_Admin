...
class ToYardManagementExpansionColumn {
  ...
  static List<OperanceDataColumn<ToYardManagementExpansionModel>> columns = [
    OperanceDataColumn<ToYardManagementExpansionModel>(
      name: 'Item Name',
      width: _width,
      columnHeader: Text(
        'Item Name',
