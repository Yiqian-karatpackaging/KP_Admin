...
class ToCompletedContainersExpansionColumn {
  ...
  static List<OperanceDataColumn<ToCompletedContainersExpansionModel>> columns = [
    OperanceDataColumn<ToCompletedContainersExpansionModel>(
      name: 'Item Name',
      width: _width,
      columnHeader: Text(
        'Item Name',
