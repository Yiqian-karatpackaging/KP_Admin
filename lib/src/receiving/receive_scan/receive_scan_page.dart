...
class _CreateState extends State<ReceiveScanPage> with SingleTickerProviderStateMixin {
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  ReceiveScanItemWidget(),
                  ReceiveScanItemScanWidget(),
                  ReceiveScanScannedItemWidget(),
                  ReceiveScanWorkerAllocationWidget(),
                  ReceiveScanSupportDocsWidget()
                ],
              ),
            )
          ],
