          ...
          child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(child: RoleUserWidget<T>(data, column),),
                ],
              )
          ),
        );
...
class RoleUserWidget<T> extends StatefulWidget {

  final List<T> data;

  final List<OperanceDataColumn<T>> column;

  const RoleUserWidget(this.data, this.column, {
    super.key,
  });

  @override
  State<RoleUserWidget> createState() => _CreateState<T>();
}

class _CreateState<T> extends State<RoleUserWidget> {
  ...
  Widget build(BuildContext context) {
    return OperanceDataTable<T>(
      ...
      header: [
        SearchButtonWidget(title: 'Remove', onTap: (){})
      ],
