    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(padding: EdgeInsets.only(top: 8.h), child: SearchDropdownWidget(title: 'Role Area', textFieldWidth: 20.w, onChanged: () {}),),
          Padding(padding: EdgeInsets.only(top: 8.h), child: SearchTextFieldWidget(title: 'Role Name', textWidth: 40.w, onChanged: () {}),),
          Padding(padding: EdgeInsets.only(top: 8.h), child: SearchTextFieldWidget(title: 'Description', textWidth: 40.w, moreLine: true, onChanged: () {}),),
          SizedBox(height: 8.h),
          Row(
