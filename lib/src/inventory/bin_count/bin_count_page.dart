import 'bin_count.dart';

class BinCountPage extends StatefulWidget {
  const BinCountPage({
    super.key,
  });

  @override
  State<BinCountPage> createState() => _CreateState();
}

class _CreateState extends State<BinCountPage> {
