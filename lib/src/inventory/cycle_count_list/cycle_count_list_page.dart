...
class CycleCountListPage extends StatefulWidget {
  ...
  @override
  State<CycleCountListPage> createState() => _CreateState();
}

class _CreateState extends State<CycleCountListPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      ...
      title: 'Inventory / Cycle Count List',
      body: SizedBox(
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  CycleCountItemWidget(),
                  CycleCountBulkListWidget()
                ],
              ),
            )
          ],
