...
class CycleCountBulkListColumn {
  ...
  static List<OperanceDataColumn<CycleCountBulkListModel>> columns = [
    OperanceDataColumn<CycleCountBulkListModel>(
      name: 'LPN',
      columnHeader: Text(
        'LPN',
