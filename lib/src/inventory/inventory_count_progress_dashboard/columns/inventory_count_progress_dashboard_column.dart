...
class InventoryCountProgressDashboardColumn {
  ...
  static const _leftWidth = OperanceDataColumnWidth(factor:  1 / 5);

  static List<OperanceDataColumn<InventoryCountProgressDashboardModel>> leftColumns = [
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
      name: 'CCID',
      width: _leftWidth,
      columnHeader: Text(
        'CCID',
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.ccId,);
      },
    ),
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
      name: 'CreatedBy',
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.createdBy,);
      },
    ),
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
      name: 'createdDate',
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.createdDate,);
      },
    ),
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
    ...
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.isRecount,);
      },
    ),
  ];


  static const _rightWidth = OperanceDataColumnWidth(factor:  1 / 4);

  static List<OperanceDataColumn<InventoryCountProgressDashboardModel>> rightColumns = [
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
      name: 'CCID',
      width: _rightWidth,
      columnHeader: Text(
    ...
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.startTime,);
      },
    ),
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
      name: 'duration',
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.duration,);
      },
    ),
    OperanceDataColumn<InventoryCountProgressDashboardModel>(
      name: 'isRecount',
