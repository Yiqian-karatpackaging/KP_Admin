...
class BulkPlateNumberHistoryColumn {
  ...
  static List<OperanceDataColumn<BulkPlateNumberHistoryModel>> columns = [
    OperanceDataColumn<BulkPlateNumberHistoryModel>(
      name: 'override',
      width: _width,
      columnHeader: Text(
        'Override',
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.override,);
      },
    ),
    OperanceDataColumn<BulkPlateNumberHistoryModel>(
      name: 'user',
    ...
    OperanceDataColumn<BulkPlateNumberHistoryModel>(
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.date,);
      },
    ),
  ];
}