...
class InterDeptItemTransferAddUnitsColumn {
  ...
  static const _width = OperanceDataColumnWidth(factor: 1 / 3);

  static List<OperanceDataColumn<InterDeptItemTransferAddUnitsModel>> columns = [
    OperanceDataColumn<InterDeptItemTransferAddUnitsModel>(
      name: '',
      width: _width,
      columnHeader: Text(
        'action',
    ...
    OperanceDataColumn<InterDeptItemTransferAddUnitsModel>(
      name: 'Units Type (Karat Portal)',
      width: _width,
      columnHeader: Text(
        'Units Type (Karat Portal)',
        style: columnHeaderStyle,
      ),
      cellBuilder: (context, item) {
        return BaseText(
