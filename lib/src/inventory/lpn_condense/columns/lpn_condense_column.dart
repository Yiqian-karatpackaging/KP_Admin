...
class LPNCondenseColumn {
  ...
  static List<OperanceDataColumn<LPNCondenseModel>> columns = [
    OperanceDataColumn<LPNCondenseModel>(
      name: 'scanId',
      columnHeader: Text(
        'ScanId',
    ...
    OperanceDataColumn<LPNCondenseModel>(
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.container);
      },
    ),
    OperanceDataColumn<LPNCondenseModel>(
      name: 'binUpdatedBy',
