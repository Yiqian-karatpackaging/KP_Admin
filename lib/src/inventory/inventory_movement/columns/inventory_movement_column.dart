...
class InventoryMovementColumn {
  ...
  static List<OperanceDataColumn<InventoryMovementModel>> columns = [
    OperanceDataColumn<InventoryMovementModel>(
      name: 'so',
      columnHeader: Text(
        'SO#',
