...
class CycleCountReviewColumn {
  ...
  static List<OperanceDataColumn<CycleCountReviewModel>> columns = [
    OperanceDataColumn<CycleCountReviewModel>(
      name: 'lpn',
      columnHeader: Text(
        'LPN#',
    ...
    OperanceDataColumn<CycleCountReviewModel>(
      ...
      cellBuilder: (context, item) {
        return BaseText(text: item.cycleCountID);
      },
    ),
    OperanceDataColumn<CycleCountReviewModel>(
      name: 'itemCode',
