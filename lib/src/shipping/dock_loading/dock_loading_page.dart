...
class DockLoadingPage extends StatefulWidget {

  const DockLoadingPage({
    super.key,
  });

  @override
  State<DockLoadingPage> createState() => _CreateState();
}

class _CreateState extends State<DockLoadingPage> with SingleTickerProviderStateMixin {
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  DockLoadingSoToWidget(),
                  DockLoadingPalletIdScanWidget(),
                  DockLoadingPalletsWidget(),
                  DockLoadingPhotoWidget(),
                  DockLoadingLoadOverrideWidget(),
                ],
              ),
            )
          ],
