...
///
class DockLoadingPalletIdScanModel {
  String soCode;
  String palletID;
  String zone;
  String spot;
  ...
  factory DockLoadingPalletIdScanModel.fromJson(List<dynamic> json) {
    return DockLoadingPalletIdScanModel(
