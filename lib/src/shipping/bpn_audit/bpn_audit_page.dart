...
class BPNAuditPage extends StatefulWidget {
  ...
  @override
  State<BPNAuditPage> createState() => _CreateState();
}

class _CreateState extends State<BPNAuditPage> with SingleTickerProviderStateMixin {
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  BPNAuditListWidget((value) {
                    _tabController?.animateTo(1);
                    setState(() {
                      // _soPickModel = value;
                    });
                  }),
                  BpnHistoryAuditWidget(),
                  BpnHistorySupportDocs(),
                ],
              ),
            )
          ],
